...
| # | Project | Platform | Tech Stack | Highlights |
|:-:|---------|:--------:|------------|------------|
| 🌿 | **CarbonWiseSL** | 🌐 Web | `React` `Python FastAPI` `Docker` `Firebase` | Carbon footprint tracking for Sri Lanka |
| 🍽️ | **Forgotten Recipes** | 🌐 Web | `MongoDB` `Express.js` `React` `Node.js` | MERN Stack recipe discovery app |
| 💪 | **Fitzone Fitness Center** | 🌐 Web | `HTML` `CSS` `PHP` `SQL` | Full-featured gym management system |
| 🏨 | **Luxevista Resort** | 📱 Mobile | `Java` `Android Studio` | Native Android resort booking app |

### 🧑‍💻 Personal Projects

| # | Project | Platform | Tech Stack | Highlights |
|:-:|---------|:--------:|------------|------------|
| 📚 | **Tutor Finder** | 🌐 Web | `React` `Java Spring Boot` `MySQL` | Connect students with tutors seamlessly |
| 🗂️ | **Leave Request Tracker** | 🖥️ Desktop | `C#` `.NET` | Streamlined employee leave management |
...
<div align="center">
<img src="https://github-readme-activity-graph.vercel.app/graph?username=madhukavirajith&theme=tokyo-night&hide_border=true&area=true" width="100%"/>
</div>
...
[![LinkedIn](https://img.shields.io/badge/Connect_on_LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/madhuka-virajith-599ba42a4/)
[![Email](https://img.shields.io/badge/Send_an_Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:virajith404@gmail.com)
